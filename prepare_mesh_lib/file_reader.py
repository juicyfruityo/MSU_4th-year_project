...
class FileReader:
    ...
    def prepare_nodes(self):
        ...
        # из строчек, в каждой из которой коортинаты точек,
        ...
        with open(self.dir_name + '/nodes_df.csv', 'w') as write_file:
    ...
    def prepare_elements(self):
        ...
        with open(self.dir_name + '/elements_df.csv', 'w') as write_file:
            print('Attention dimension of mesh == {0}'.format(self.dim))
